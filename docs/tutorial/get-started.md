...
```
One thing to notice is that value does not contain an Id property. Since it is an autoincrement column, it will be automatically generated by jsstore. Now, let's insert this value into db -  
...
Lets say I want to update Quantity to 2000 on the products with Item Name containing the substring 'black'.
