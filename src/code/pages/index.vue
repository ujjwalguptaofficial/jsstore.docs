    ...
    return {
      meta: [
        ...
        },
        {
          ...
          name: "description",
          content:
            "JsStore is a client side javascript library for performing database operation inside indexeddb."
        }
      ]
    };
  }
